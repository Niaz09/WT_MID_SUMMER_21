		...
		<form action="" method="post">
			<table>
				...
				<tr>
					...
					<td>
						<input type="checkbox" value="Music" name="hobbies[]">Music  <input type="checkbox" value="Movies" name="hobbies[]">Movies
						<br> &nbsp;<input type="checkbox" value="Sports" name="hobbies[]">Sports  <input type="checkbox" value="Games" name="hobbies[]">Games 
					</td>
				</tr>
				<tr>
